...
public static class WorkbenchConfigurationExtensions
{
    private static readonly IReadOnlyDictionary<string, string> SingleUnderscoreEnvironmentVariables =
        new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
        {
            ...
            ["NEXUSAUTH_GATEWAY_BOOTSTRAP_ENABLED"] = "GatewayBootstrap:Enabled",
            ["NEXUSAUTH_GATEWAY_BOOTSTRAP_CLIENT_ID"] = "GatewayBootstrap:ClientId",
            ["NEXUSAUTH_GATEWAY_BOOTSTRAP_CLIENT_SECRET"] = "GatewayBootstrap:ClientSecret",
            ["NEXUSAUTH_GATEWAY_BOOTSTRAP_CLIENT_NAME"] = "GatewayBootstrap:ClientName",
            ["NEXUSAUTH_GATEWAY_BOOTSTRAP_CLIENT_DESCRIPTION"] = "GatewayBootstrap:ClientDescription",
            ["NEXUSAUTH_GATEWAY_BOOTSTRAP_REDIRECT_URI"] = "GatewayBootstrap:RedirectUri",
            ["NEXUSAUTH_GATEWAY_BOOTSTRAP_POST_LOGOUT_REDIRECT_URI"] = "GatewayBootstrap:PostLogoutRedirectUri",
            ["NEXUSAUTH_GATEWAY_BOOTSTRAP_ALLOWED_SCOPES"] = "GatewayBootstrap:AllowedScopes",
